...
export function Reviews() { // Renamed from Testimonials to Reviews to match App.jsx
  ...
  const reviews = [
    ...
    },
    {
      ...
      quote: 'Working with Adam was a game changer for our travel agency. His designs captured the spirit of travel perfectly and made our social media look professional and inspiring.',
    ...
    },
    {
      ...
      name: 'Mohammed Iyad',
      role: 'Video Editor',
      quote: 'Adam’s creativity and technical skills made our collaboration seamless. He communicates clearly and always delivers high-quality work on time.',
